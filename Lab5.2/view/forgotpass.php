...
<body>
    <table cellspacing="0" border="1" height="100%" width="100%">
        <tr>
            <td colspan="3"><img src="../assets/i.png" alt="" srcset="" height="80px" width="150px">
            ...
            <td colspan="3" height="576px">
                <form action="" method="post" style="display: flex; flex-direction: column; align-items: center;">
                    <fieldset>
                        ...
                        <table>
                            <tr>
                                <td align="right"><label for="usermail">Enter email :</label></td>
                                <td><input type="email" id="usermail" name="usermail"></td>
                            </tr>
                        </table>
                        <hr>
